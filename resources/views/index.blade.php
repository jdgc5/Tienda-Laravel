...
<!--===============================================================================================-->
	...
	<link rel="stylesheet" type="text/css" href="{{ url('frontend/css/propio.css') }}">
<!--===============================================================================================-->
...
<div class="container-menu-desktop">
    ...
    <div class="top-bar">
        <div class="content-topbar flex-sb-m h-full container">
            <div class="left-top-bar flex-grow-1">
                @if (auth()->check())
                    <p>¡Bienvenido, {{ auth()->user()->name }}</p>
                @else
                    Te recomendamos iniciar el registro.
                @endif
            </div>
            ...
            @if (auth()->check())
                @if (auth()->user()->tipo === 'admin')
                    <a href="{{ url('admin') }}" class="flex-c-m trans-04 p-lr-25">Admin Area</a>
                @endif
            @endif
            	
                @if (auth()->check())
                <a class="flex-c-m trans-04 p-lr-25">
                    <form id="logout-form" action="{{ route('usera.logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="d-flex btn btn-link"  style="margin-bottom: 0;">Cerrar sesión</button>
                    </form>
                    </a>
                <script>
                ...
                @else
                    <a href="{{ url('user/create') }}" class="flex-c-m trans-04 p-lr-25">Registrarse</a>
                @endif
                
                @if (auth()->check())
	                <a href="#" class="flex-c-m trans-04 p-lr-25">Mi cuenta</a>
                @else 
                	<a href="{{url('usera/login')}}" class="flex-c-m trans-04 p-lr-25">Logearse</a>
                @endif
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
			    <a href="{{ url('index') }}"><img src="{{ url('frontend/images/icons/logo-01.png') }}" alt="IMG-LOGO"></a>
	...
	<div class="wrap-header-cart js-panel-cart">
		...
		<div class="header-cart flex-col-l p-l-65 p-r-25">
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full" id="carritoItemsContenedor">
					<!-- ITEMS DE CART EMPIEZA AQUI -->
					<!-- ITEMS DE CART ACABA AQUI -->
				</ul>
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="#!" id="eliminarCompras" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							Eliminar Compras
						</a>
		                <script>
				        document.getElementById('eliminarCompras').addEventListener('click', function() {
				            limpiarCarrito();
				        });
		    			</script>
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1" data-filter="*" onclick="cargarProductos()">
						Todos los Productos
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".women" onclick="cargarProductos(1, 'mujer')">
						Mujeres
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".men" onclick="cargarProductos(1, 'hombre')">
						Hombres
					</button>
				...
				<div class="flex-w flex-c-m m-tb-10">
		            <div class="flex-c-m stext-106 cl6 size-104 trans-04 m-r-8 m-tb-4">
		              <span class="mx-2">Ver</span>
		              <select id="perPageSelect" class="mx-2">
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search-product" placeholder="Buscar" id="search-product">
					</div>	
				</div>
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						...
						<div class="filter-col2 p-r-15 p-b-27">
							...
							<ul>
								<li class="p-b-6">
									<a href="#" class="filter-link stext-106 trans-04 filter-link-active" data-price-range="*">
										All
									</a>
								</li>

								<li class="p-b-6">
									<a href="#" class="filter-link stext-106 trans-04" data-price-range="0-50">
										€0.00 - €50.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="#" class="filter-link stext-106 trans-04" data-price-range="50-100">
										€50.00 - €100.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="#" class="filter-link stext-106 trans-04" data-price-range="100-150">
										€100.00 - €150.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="#" class="filter-link stext-106 trans-04" data-price-range="150-200">
										€150.00 - €200.00
									</a>
								</li>

								<li class="p-b-6">
									<a href="#" class="filter-link stext-106 trans-04" data-price-range="200-950">
										€200.00+
									</a>
								</li>
							</ul>
	...
	<div class="row">
        ...
        <div class="products-grid col-12">
          <header class="product-grid-header">
            <div class="me-3 mb-3" id="paginationInfo">
               Enseñando <strong id="paginationRange"></strong> de <strong id="totalProducts"></strong> productos

          </header>
			<div class="row isotope-grid" id="productos">
			</div>
			  ...
			  <!-- AQUI SE DEBERIA PAGINAR -->
	        <div id="paginacion" class="m-auto">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<div class="wrap-modal1 js-modal1 p-t-60 p-b-20">
		...
		<script src="{{ url('frontend/js/fetch.js') }}"></script>
	<script src="{{ url('frontend/js/carrito.js') }}"></script>
